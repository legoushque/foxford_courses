...
def selector():
    ...
    cls()
    print("\n-------------------------------")
    print("1. Извлечь теорию + дз")
    print("2. Извлечь видео")
    print("3. Просмотр")
    print("4. Навестить репозиторий автора")
    print("0. Выйти")
    print("-------------------------------\n")
...
def auth():
    ...
    while True:
        try:
            # Show login page or dashboard
            login_to_foxford(driver, psk=True)
            cls()
            print("\nВыбирай курс, смотри на здоровье, братишка.")
