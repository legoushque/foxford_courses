...
1. Установи Node.js (10+) и Chrome (60+). После этого нужно установить кодеки. Есть для [Windows](https://www.codecguide.com/download_k-lite_codec_pack_mega.htm),Процесс скачивания есть для [Linux](https://gist.github.com/limitedeternity/b82edd9c7c0e8e6b4e100428addf4661).
